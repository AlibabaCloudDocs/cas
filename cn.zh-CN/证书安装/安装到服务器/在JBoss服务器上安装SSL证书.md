...
阿里云SSL证书服务支持下载证书安装到JBoos服务器，从而使JBoss服务器支持HTTPS安全访问。本文介绍了证书安装的具体操作。
...
5.  部署证书。
    ...
    4.  验证。
        ...
        ![验证](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/4866495751/p4311.png)
